...
Tops = Frame(root,width= 400,height = 100, bd=5, relief="raise")
Tops.pack(side=TOP)
...
fChickenLeft = Frame(fMLT,width= 400,height = 250, bd=5, relief="raise")
fChickenLeft.pack(side=LEFT)
fChickenRight = Frame(fMLT,width= 400,height = 250, bd=5, relief="raise")
...
lblInfo = Label(Tops,font=('TH Sarabun New',15,'bold'),text = "Chick-ka-boo",bg="yellow",bd=5)
lblServer = Label(Tops,font=('TH Sarabun New',15,'bold'),text = "Server",bg="yellow",bd=5)
lblEmail = Label(Tops,font=('TH Sarabun New',15,'bold'),text = "E-Mail",bg="yellow",bd=5)
...
txtServer = Entry(Tops ,font=('TH Sarabun New',12,'bold'),bd=5,width=15,justify='left',textvariable=EntryServer, state = NORMAL)
txtServer.grid(row=1,column =1)

#============================= E-Mail =====================
EntryEmail = StringVar()

txtEmail = Entry(Tops ,font=('TH Sarabun New',12,'bold'),bd=5,width=15,justify='left',textvariable=EntryEmail, state = NORMAL)
...
Chicken0 = Checkbutton(fChickenLeft , text=ChickenList[0],variable = VarChickenList[0] ,onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',12,'bold'),command=lambda:chkbutton_value(VarChickenList[0],txtChicken0,EntryChickenList[0])).grid(row= 0, sticky=W)
Chicken1 = Checkbutton(fChickenLeft , text=ChickenList[1],variable = VarChickenList[1],onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',12,'bold'),command=lambda:chkbutton_value(VarChickenList[1],txtChicken1,EntryChickenList[1])).grid(row= 1, sticky=W)
Chicken2 = Checkbutton(fChickenLeft , text=ChickenList[2],variable = VarChickenList[2],onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',12,'bold'),command=lambda:chkbutton_value(VarChickenList[2],txtChicken2,EntryChickenList[2])).grid(row= 2, sticky=W)
Chicken3 = Checkbutton(fChickenLeft , text=ChickenList[3],variable = VarChickenList[3],onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',12,'bold'),command=lambda:chkbutton_value(VarChickenList[3],txtChicken3,EntryChickenList[3])).grid(row= 3, sticky=W)
Chicken4 = Checkbutton(fChickenLeft , text=ChickenList[4],variable = VarChickenList[4],onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',12,'bold'),command=lambda:chkbutton_value(VarChickenList[4],txtChicken4,EntryChickenList[4])).grid(row= 4, sticky=W)
Chicken5 = Checkbutton(fChickenLeft , text=ChickenList[5],variable = VarChickenList[5],onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',12,'bold'),command=lambda:chkbutton_value(VarChickenList[5],txtChicken5,EntryChickenList[5])).grid(row= 5, sticky=W)
Chicken6 = Checkbutton(fChickenLeft , text=ChickenList[6],variable = VarChickenList[6],onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',12,'bold'),command=lambda:chkbutton_value(VarChickenList[6],txtChicken6,EntryChickenList[6])).grid(row= 6, sticky=W)
...
Chicken8 = Checkbutton(fChickenRight , text=ChickenList[8],variable = VarChickenList[8],onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',12,'bold'),command=lambda:chkbutton_value(VarChickenList[8],txtChicken8,EntryChickenList[8])).grid(row= 8, sticky=W)
Chicken9 = Checkbutton(fChickenRight , text=ChickenList[9],variable = VarChickenList[9],onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',12,'bold'),command=lambda:chkbutton_value(VarChickenList[9],txtChicken9,EntryChickenList[9])).grid(row= 9, sticky=W)
Chicken10 = Checkbutton(fChickenRight , text=ChickenList[10],variable = VarChickenList[10],onvalue = 1, offvalue=0,
                    font=('TH Sarabun New',12,'bold'),command=lambda:chkbutton_value(VarChickenList[10],txtChicken10,EntryChickenList[10])).grid(row= 10, sticky=W)
...
txtChicken0 = Entry(fChickenLeft ,font=('TH Sarabun New',12,'bold'),bd=5,width=6,justify='left',textvariable=EntryChickenList[0],state = DISABLED)
txtChicken0.grid(row=0,column =1)
txtChicken1 = Entry(fChickenLeft ,font=('TH Sarabun New',12,'bold'),bd=5,width=6,justify='left',textvariable=EntryChickenList[1],state = DISABLED)
txtChicken1.grid(row=1,column =1)
txtChicken2 = Entry(fChickenLeft ,font=('TH Sarabun New',12,'bold'),bd=5,width=6,justify='left',textvariable=EntryChickenList[2],state = DISABLED)
txtChicken2.grid(row=2,column =1)
txtChicken3 = Entry(fChickenLeft ,font=('TH Sarabun New',12,'bold'),bd=5,width=6,justify='left',textvariable=EntryChickenList[3],state = DISABLED)
txtChicken3.grid(row=3,column =1)
txtChicken4 = Entry(fChickenLeft ,font=('TH Sarabun New',12,'bold'),bd=5,width=6,justify='left',textvariable=EntryChickenList[4],state = DISABLED)
txtChicken4.grid(row=4,column =1)
txtChicken5 = Entry(fChickenLeft ,font=('TH Sarabun New',12,'bold'),bd=5,width=6,justify='left',textvariable=EntryChickenList[5],state = DISABLED)
txtChicken5.grid(row=5,column =1)
txtChicken6 = Entry(fChickenLeft ,font=('TH Sarabun New',12,'bold'),bd=5,width=6,justify='left',textvariable=EntryChickenList[6],state = DISABLED)
txtChicken6.grid(row=6,column =1)
txtChicken7 = Entry(fChickenLeft ,font=('TH Sarabun New',12,'bold'),bd=5,width=6,justify='left',textvariable=EntryChickenList[7],state = DISABLED)
txtChicken7.grid(row=7,column =1)

txtChicken8 = Entry(fChickenRight ,font=('TH Sarabun New',12,'bold'),bd=5,width=6,justify='left',textvariable=EntryChickenList[7],state = DISABLED)
txtChicken8.grid(row=8,column =1)
txtChicken9 = Entry(fChickenRight ,font=('TH Sarabun New',12,'bold'),bd=5,width=6,justify='left',textvariable=EntryChickenList[7],state = DISABLED)
txtChicken9.grid(row=9,column =1)
txtChicken10 = Entry(fChickenRight ,font=('TH Sarabun New',12,'bold'),bd=5,width=6,justify='left',textvariable=EntryChickenList[7],state = DISABLED)
txtChicken10.grid(row=10,column =1)
txtChicken11 = Entry(fChickenRight ,font=('TH Sarabun New',12,'bold'),bd=5,width=6,justify='left',textvariable=EntryChickenList[7],state = DISABLED)
...
#================================== Receipt Information ===================
lblReceipt = Label(fReceipt,font=('TH Sarabun New',13,'bold'), text="Receipt", bd=2,anchor='w')
lblReceipt.grid(row=0,column=0, sticky=W)
txtReceipt = Text(fReceipt,font=('TH Sarabun New',12,'bold'), bd=5,width=59,height=10,bg="white")
txtReceipt.grid(row=1,column=0)

#=================================== Cost Items Information============
lblCostofChicken = Label(fCost1,font=('TH Sarabun New',12,'bold'),text="Cost of Chickens",bd=5)
lblCostofChicken.grid(row=0,column=0,sticky=W)
txtCostofChicken=Entry(fCost1,font=('TH Sarabun New',12,'bold'),bd=5,justify='left',
                      textvariable=CostofChicken)
txtCostofChicken.grid(row=0,column=1,sticky=W)

lblServiceCharge = Label(fCost1,font=('TH Sarabun New',12,'bold'),text="Service Charge",bd=5)
lblServiceCharge.grid(row=2,column=0,sticky=W)
txtServiceCharge=Entry(fCost1,font=('TH Sarabun New',12,'bold'),bd=5,justify='left',
                       textvariable=ServiceCharge)
txtServiceCharge.grid(row=2,column=1,sticky=W)

#=========================== Payment Information========================
lblPaidTax = Label(fCost2,font=('TH Sarabun New',12,'bold'),text="Paid Tax",bd=5)
lblPaidTax.grid(row=0,column=0,sticky=W)
txtPaidTax=Entry(fCost2,font=('TH Sarabun New',12,'bold'),bd=5,justify='left',
                 textvariable=PaidTax)
txtPaidTax.grid(row=0,column=1,sticky=W)

lblSubTotal = Label(fCost2,font=('TH Sarabun New',12,'bold'),text="Sub Total",bd=5)
lblSubTotal.grid(row=1,column=0,sticky=W)
txtSubTotal=Entry(fCost2,font=('TH Sarabun New',12,'bold'),bd=5,justify='left',
                  textvariable=SubTotal)
txtSubTotal.grid(row=1,column=1,sticky=W)

lblTotalCost = Label(fCost2,font=('TH Sarabun New',12,'bold'),text="Total",bd=5)
lblTotalCost.grid(row=2,column=0,sticky=W)
txtTotalCost=Entry(fCost2,font=('TH Sarabun New',12,'bold'),bd=5,justify='left',
...
btnServer=Button(Tops,padx=16, fg="black",font=('TH Sarabun New',12,'bold'),width=5,
                text="Access",command=serverAccess).grid(row=1, column=2)
btnEmail=Button(Tops,padx=16, fg="black",font=('TH Sarabun New',12,'bold'),width=5,
                text="Access",command=emailAccess).grid(row=2, column=2)
btnSendFile=Button(Tops,padx=16, fg="black",font=('TH Sarabun New',12,'bold'),width=5,
                text="Access",command=sendFile).grid(row=0, column=2)
