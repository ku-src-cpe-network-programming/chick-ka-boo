...
txtChicken0 = Entry(fChicken00 ,font=('TH Sarabun New',12,'bold'),bd=5,width=7,justify='right',textvariable=EntryChickenList[0],state = DISABLED)
txtChicken0.grid(row=0,column =2)
txtChicken1 = Entry(fChicken00 ,font=('TH Sarabun New',12,'bold'),bd=5,width=8,justify='right',textvariable=EntryChickenList[1],state = DISABLED)
txtChicken1.grid(row=0,column =4)
txtChicken2 = Entry(fChicken00 ,font=('TH Sarabun New',12,'bold'),bd=5,width=14,justify='right',textvariable=EntryChickenList[2],state = DISABLED)
txtChicken2.grid(row=0,column =6)
txtChicken3 = Entry(fChicken00 ,font=('TH Sarabun New',12,'bold'),bd=5,width=6,justify='right',textvariable=EntryChickenList[3],state = DISABLED)
txtChicken3.grid(row=0,column =8)

txtChicken4 = Entry(fChicken11 ,font=('TH Sarabun New',12,'bold'),bd=5,width=10,justify='right',textvariable=EntryChickenList[4],state = DISABLED)
txtChicken4.grid(row=1,column =1)
txtChicken5 = Entry(fChicken11 ,font=('TH Sarabun New',12,'bold'),bd=5,width=17,justify='right',textvariable=EntryChickenList[5],state = DISABLED)
txtChicken5.grid(row=1,column =3)
txtChicken6 = Entry(fChicken11 ,font=('TH Sarabun New',12,'bold'),bd=5,width=17,justify='right',textvariable=EntryChickenList[6],state = DISABLED)
...
txtChicken8 = Entry(fChicken22 ,font=('TH Sarabun New',12,'bold'),bd=5,width=19,justify='right',textvariable=EntryChickenList[7],state = DISABLED)
txtChicken8.grid(row=1,column =1)
txtChicken9 = Entry(fChicken22 ,font=('TH Sarabun New',12,'bold'),bd=5,width=24,justify='right',textvariable=EntryChickenList[8],state = DISABLED)
txtChicken9.grid(row=1,column =3)
txtChicken10 = Entry(fChicken22 ,font=('TH Sarabun New',12,'bold'),bd=5,width=18,justify='right',textvariable=EntryChickenList[9],state = DISABLED)
